...
#[derive(Debug, Copy, Clone)]
pub struct point {
    #[doc = "The list of objective values"]
    pub objectives: *mut f64,
}
#[test]
fn bindgen_test_layout_point() {
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).objectives) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(point),
...
#[doc = "A struct defining the front with the objective valued."]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct front {
    #[doc = "The number of points or individuals in the front"]
    pub number_of_individuals: ::std::os::raw::c_int,
    #[doc = "The number of objectives"]
    pub number_of_objectives: ::std::os::raw::c_int,
    #[doc = "The points"]
    pub points: *mut point,
}
#[test]
fn bindgen_test_layout_front() {
    const UNINIT: ::std::mem::MaybeUninit<front> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<front>(),
        16usize,
        concat!("Size of: ", stringify!(front))
    );
    assert_eq!(
        ::std::mem::align_of::<front>(),
        8usize,
        concat!("Alignment of ", stringify!(front))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).number_of_individuals) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(front),
            "::",
            stringify!(number_of_individuals)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).number_of_objectives) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(front),
            "::",
            stringify!(number_of_objectives)
        )
    );
    assert_eq!(
...
extern "C" {
    ...
    pub fn calculate_hypervolume(arg1: front, arg2: point) -> f64;
}
